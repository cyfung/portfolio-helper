...
internal fun toIbkrTradeDto(
    ...
    exchange = trade.exchange.trim().uppercase(),
...
internal fun toIbkrTradeDto(
    ...
    exchange = execution.exchange.trim().uppercase(),
...
private data class AppConfigDto(
    ...
    val downloadBytesReceived: Long,
        ...
        get("/api/portfolio/data") {
            ...
            val response = PortfolioDataResponse(
                ...
                appConfig = AppConfigDto(
                    ...
                    downloadBytesReceived = updateInfo.download.bytesReceived,
                    downloadTotalBytes = updateInfo.download.totalBytes,
