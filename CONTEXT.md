...
**Flexible weight mapping**:
A bidirectional relationship between instrument expressions that permits offsetting allocation deviations and rebalancing amounts to move between them.
_Avoid_: Flexible setting, flexibility rule

**Flexible rebalancing mode**:
A portfolio display mode that presents target weights and rebalancing amounts after applying its flexible weight mappings.
_Avoid_: Flexible toggle, F mode
