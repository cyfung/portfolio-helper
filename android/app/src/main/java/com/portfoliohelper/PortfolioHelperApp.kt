        ...
        Room.databaseBuilder(this, AppDatabase::class.java, "portfoliohelper.db")
            ...
            .addCallback(object : RoomDatabase.Callback() {
                override fun onCreate(db: SupportSQLiteDatabase) {
                    db.execSQL("INSERT INTO portfolios (serialId, displayName, slug, flexibleWeightMappings) VALUES (1, 'Main', '', '')")
                    db.execSQL("INSERT INTO portfolio_margin_alerts (portfolioId, lowerPct, upperPct) VALUES (1, -1.0, -1.0)")
                }

                override fun onOpen(db: SupportSQLiteDatabase) {
                    db.execSQL("INSERT INTO portfolios (serialId, displayName, slug, flexibleWeightMappings) SELECT 1, 'Main', '', '' WHERE NOT EXISTS (SELECT 1 FROM portfolios)")
